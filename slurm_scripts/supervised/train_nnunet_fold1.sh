...
#SBATCH --gres=gpu:1
#SBATCH --output=/vol/biomedic2/bglocker_studproj/am525/3d-brain-ssl/slurm_logs/supervised/train_nnunet_fold1.%N.%j.log
#SBATCH --time=20-00:00:00
#SBATCH --job-name=train_nnunet_fold1
...
export WANDB_NAME=nnunet_bratsmen_fold1
